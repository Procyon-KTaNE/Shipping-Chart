    ...
    static class MainClass
    {
        ...
        public static void Main(string[] args)
        {
            ...
            do
            {
                ...
                string[] names = { "John  ", "Rose  ", "Dave  ", "Jade  ", "Aradia", "Tavros", "Sollux", "Karkat", "Nepeta", "Kanaya", "Terezi", "Vriska", "Equius", "Gamzee", "Eridan", "Feferi" };
                ...
                // The four possible shipping charts are not printed here 
                ...
                //  Need this for souvenir
                string souvenir = suitsOnModule[Array.IndexOf(characters, 14) / 4 + Array.IndexOf(characters, 15) / 4 - 1].ToString();
